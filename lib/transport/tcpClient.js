 ...
 * @constructor
 */
 TcpClient.prototype.createChannel = function TcpClient_createChannel(urlStr){
  ...
  console.log("TCP CONNECTING TO " + channelContext["server.RemoteIpAddress"] + ":" + channelContext["server.RemotePort"]);
      var socket = net.createConnection(
        ...
        function() {
          ...
          channelContext["server.RawStream"].on('finish', that._closeContext.bind(that, channelContext));
