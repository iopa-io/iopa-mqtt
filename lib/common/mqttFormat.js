 ...
 */
 var Promise = require('bluebird')
    ...
    , util = require('util')
    , iopaStream = require('iopa-core').Stream
     ...
     var parser  = MqttPacket.parser();
      ...
      function _invokePacket(packet) {
        ...
        _parsePacket(packet, context);
         console.log("[MQTTFORMAT] Created " + context["iopa.Method"]);
      ...
      function _error(context) {
        console.log("[MQTTFORMAT] Error parsing MQTT Packet");
      } 
};
...
function _onClose(ctx) {
    setTimeout(function() {
       console.log("[MQTTFORMAT] Disposed " + ctx["iopa.Method"]);
