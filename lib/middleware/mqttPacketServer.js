 ...
 */
MQTTPacketServer.prototype.invoke = function MQTTPacketServer(context, next) {
    
    MqttFormat.inboundParseMonitor(context, "request");
    
    return next().then(function(){ return new Promise(function(resolve, reject){
           context["mqttPacketServer.Close"] = resolve;
           context["mqttPacketServer.Error"] = reject;
        }); 
    });
};
